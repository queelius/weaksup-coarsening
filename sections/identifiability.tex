...
triplet method of \citet{fu2020fast}; the identifiability it delivers
is a special case of the general latent-structure identifiability
theorem of \citet{allman2009identifiability}, built on
\citeauthor{kruskal1977three}'s uniqueness result for trilinear
decompositions \citep{kruskal1977three}. From three LFs, the three
