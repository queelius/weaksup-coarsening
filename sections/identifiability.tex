...
made fully explicit as a label-flip symmetry. A single gold-labeled
example breaks the symmetry: it is a singleton candidate set whose
known label fixes the orientation, adding an identifying row to the
augmented candidate-set matrix of \cref{thm:bg-id}. The
