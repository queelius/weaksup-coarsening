...
requirement scales as $1/\mathrm{gap}^2$ in the accuracy margin (fitted
log--log slope $-2.04$) and linearly in the degeneracy dimension $r$
for total model recovery (fitted log--log slope $1.17$).

Dawid--Skene (1979) is the clear ancestor of the label model,
...
identifiability up to label swapping is due to \citet{yu2022nplm}; the
contribution here is the masked-cause
...
for the dependent case, both factors of which the present simulation
validates. The framework gives a practitioner a
