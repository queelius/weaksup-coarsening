...
is the genuinely new quantitative result, and the empirical
$\log$--$\log$ slope of $-2.04$ for the gold-set size against the
accuracy margin matches the predicted $1/\mathrm{gap}^2$ scaling.
The framework casts the C1--C2--C3 coarsening conditions of
Heitjan--Rubin and Gill--van der Laan--Robins as a classification of
LF ensembles, and gives the precise conditions under which a
gold-free weak-supervision pipeline is identifiable. Dawid--Skene
(1979) is the clear ancestor of label-model identifiability, and
